...
namespace Views.RoyalRoulette
{
    public class BetSelectorView : MonoBehaviour
    {
        ...
        [Space] [SerializeField] private Text _betText = null;

        [Space] [SerializeField] private Button _addButton = null;

        [Space] [SerializeField] private Button _minusButton = null;
        ...
        private void Awake()
        {
            ...
            _addButton.onClick.AddListener(() =>
            {
                ...
                OnValueChangedAction?.Invoke(_currentBet);
        ...
        private void UpdateButtonsState()
        {
            ...
            _addButton.interactable =
                _currentBet < Mathf.Min(1000, Wallet.Money) || Wallet.Money == 0;
        }
